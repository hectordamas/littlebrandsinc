                ...
                <div class="card-block">
                    <div class="table-responsive">
                        <table class="table table-hover table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <td><label class="form-label label label-success">open</label>
                                    </td>
                                ...
                                <tr>
                                    <td><label class="form-label label label-primary">progress</label>
                                    </td>
                                ...
                                <tr>
                                    <td><label class="form-label label label-danger">closed</label>
                                    </td>
                    ...
                    <div class="latest-update-box">
                        <div class="row p-t-20 p-b-30">
                            ...
                            <div class="col">
                                ...
                                <p class="text-muted m-b-0">You’re getting more
                                    and
                        ...
                        <div class="row p-b-0">
                            ...
                            <div class="col">
                                ...
                                <p class="text-muted m-b-10">This is great, keep
                                    it
                                    up!</p>
                                <div class="table-responsive">
